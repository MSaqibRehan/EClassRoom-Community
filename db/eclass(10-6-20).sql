...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2020 at 12:51 PM
...
--
-- RELATIONSHIPS FOR TABLE `course_program`:
--
...
--
-- RELATIONSHIPS FOR TABLE `semester_subjects`:
--
...
--
-- RELATIONSHIPS FOR TABLE `std_enrollment`:
--   `std_id`
--       `student` -> `std_id`
--   `semester_id`
...
--
-- RELATIONSHIPS FOR TABLE `teacher_class_enrollment`:
--   `teacher_id`
--       `teacher` -> `teacher_id`
--   `semester_id`
--       `semester` -> `semester_id`
