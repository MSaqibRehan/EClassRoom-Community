...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2020 at 09:26 AM
...
(1, 1, 3, 8, 2, 13, 'Welcome to hell', 'Active', '2020-06-27 20:02:46'),
(2, 1, 3, 8, 3, 10, 'testing', 'Active', '2020-06-27 20:29:35');
...
(1, 1, 3, 8, 2, 1, 1, 'Image Formate', 'Image Formate', 'Image Formate', 6, '2020-07-01 23:04:54'),
(2, 1, 3, 8, 2, 2, 1, 'pata nai', 'pata nai', 'pata nai', 6, '2020-07-02 01:36:48'),
(3, 1, 3, 8, 2, 3, 1, 'a', 'a', 'a', 6, '2020-07-03 22:47:43'),
(4, 1, 3, 8, 2, 4, 1, 'b', 'b', 'b', 6, '2020-07-03 22:50:27'),
(5, 1, 3, 8, 2, 5, 1, 'c', 'c', 'c', 6, '2020-07-03 22:50:27'),
(6, 1, 3, 8, 2, 7, 1, 'e', 'e', 'e', 6, '2020-07-03 22:51:35'),
(7, 1, 3, 8, 2, 6, 1, 'd', 'd', 'd', 6, '2020-07-03 22:52:40'),
(8, 1, 3, 8, 2, 8, 1, 'f', 'f', 'f', 6, '2020-06-25 12:40:31'),
(9, 1, 3, 8, 2, 9, 1, 'g', 'g', 'g', 6, '2020-06-25 19:52:18'),
(10, 1, 3, 8, 2, 10, 1, 'h', 'h', 'h', 6, '2020-06-25 12:40:31'),
(11, 1, 3, 8, 2, 11, 1, 'i', 'i', 'i', 6, '2020-06-25 19:52:18'),
(12, 1, 3, 8, 2, 12, 1, 'j', 'j', 'j', 6, '2020-06-25 12:40:31'),
(13, 1, 3, 8, 2, 13, 1, 'k', 'k', 'k', 6, '2020-06-25 19:52:18'),
(14, 1, 3, 8, 2, 14, 1, 'l', 'l', 'l', 6, '2020-06-25 12:40:31'),
(15, 1, 3, 8, 2, 15, 1, 'm', 'm', 'm', 6, '2020-06-25 19:52:18'),
(16, 1, 3, 8, 2, 16, 1, 'n', 'n', 'n', 6, '2020-06-25 12:40:31'),
(17, 1, 3, 8, 2, 1, 2, 'This is lecture 2', 'This is lecture 2', 'This is lecture 2', 6, '2020-06-25 19:52:18'),
(18, 1, 3, 8, 2, 2, 2, 'dsa', 'Annotation 2020-03-08 190420.jpg', 'hgerget', 6, '2020-07-06 09:53:49'),
(19, 1, 3, 8, 2, 3, 2, 'qwertyuio', 'Annotation 2020-05-22 112531.jpg', 'qwertyuiop', 6, '2020-07-06 10:17:00'),
(20, 1, 3, 8, 2, 4, 2, 'khan', 'Annotation 2020-03-18 174300.jpg', 'qwertyuiop[', 6, '2020-07-06 10:18:22'),
(21, 1, 3, 8, 2, 5, 2, 'Dip', 'image-6.png', 'qwertyuiop[', 6, '2020-07-06 12:13:47');
...
(46, 1, 3, 8, 5, 'jikkl/kl', '2020-06-27 18:40:30'),
(47, 1, 3, 8, 5, 'jikkl/kl', '2020-06-27 18:40:55'),
(48, 1, 3, 8, 5, 'arslan', '2020-06-27 18:41:11');
...
(1, 1, 8, 1, 'ABC', ' SFDSFSDFSDF', '321432432', NULL, NULL, NULL, NULL),
...
(3, 1, '2016-2020', '2016-06-03', '2016-06-03', 'Fall', 'Active', 1, '2020-06-27 19:52:18', NULL, NULL);
...
(2, 2, 3, 2, 1, '2020-06-24 03:00:02', NULL, NULL),
(3, 3, 3, 8, 1, '2020-06-24 15:48:42', NULL, NULL);
...
(9, 13, 3, 4, 3, 1, '2020-06-25 19:15:02', NULL, NULL),
(10, 13, 3, 8, 2, 1, '2020-07-02 00:44:50', NULL, NULL),
(11, 10, 3, 8, 1, 1, '2020-07-02 00:56:49', NULL, NULL);
...
(3, '12222', 'teacher', '9o76vvuX1TZTWFr3eu549PKmKSxcPeTp', '$2y$13$HtuGsPFzKS7BLPaBz1G3ke7dNfedJitiCYGXVu9ZJOn69r6VuaxlW', NULL, 'saqibrehan2007@gmail.com', 10, 1592949463, 1592949463, 'p-6ofh7-usKLsr_BML8PUX2vwp7Yu6bq_1592949463'),
...
--
ALTER TABLE `class_handouts`
  MODIFY `handout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `inbox`
  MODIFY `inbox_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `semester_subjects`
  MODIFY `sem_subj_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `std_enrollment`
  MODIFY `std_enrol_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `teacher_class_enrollment`
  MODIFY `tce_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `session`
  ADD CONSTRAINT `session_ibfk_1` FOREIGN KEY (`course_p_id`) REFERENCES `course_program` (`cp_id`);
