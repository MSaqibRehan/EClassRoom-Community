        ...
        <?= dmstr\widgets\Menu::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => 'Assignment Upload', 'icon' => 'file-text-o', 'url' => ['/assignment-upload']],
                    ['label' => 'Assignment Submit', 'icon' => 'afile-text-o', 'url' => ['/assignment-submit']],
                    ['label' => 'Assignment Remarks', 'icon' => 'file-text-o', 'url' => ['/assignment-remarks']],
                    ['label' => 'Inbox', 'icon' => 'comments-o', 'url' => ['/inbox']],
                    ['label' => 'Quizz', 'icon' => 'quora', 'url' => ['/quizz']],
                    ['label' => 'Quizz Remarks', 'icon' => 'quora', 'url' => ['/quizz-remarks']],
